...
int main() {
	...
	while (1) {
							...
							if (productTmp.size() <= AMOUNTOFITEMSOFPAGE) {
											...
											if (order <= productTmp.size()) {
												...
												while (1) {
													...
													if (choice == 1) {
														...
														cin >> amount;
														if (cosmeticList[productTmp[order - 1]].getPS() - amount < 0) {
															cout << endl << "库存不足，无法购买哦~(づ￣ 3￣)づ" << endl;
															break;
														}
								...
								for (page = 1; page * AMOUNTOFITEMSOFPAGE < productTmp.size(); page++) {
									...
									if (page == 1) {
										...
										cout << "\t\t共 " << (productTmp.size()+3) / AMOUNTOFITEMSOFPAGE << " 页/第 " << page << " 页" << endl << endl;
										cout << "您可进行的操作有：" << endl;
													...
													if (order <= AMOUNTOFITEMSOFPAGE) {
														...
														while (1) {
															...
															if (choice == 1) {
																...
																cout << endl << "请输入购买数量：" << endl;
																cin >> amount;
																if (cosmeticList[productTmp[AMOUNTOFITEMSOFPAGE * (page - 1) + order - 1]].getPS() - amount < 0) {
																	cout << endl << "库存不足，无法购买哦~(づ￣ 3￣)づ" << endl;
																	break;
																}
								...
								cout << "\t\t共 " << (productTmp.size() + 3) / AMOUNTOFITEMSOFPAGE << " 页/第 " << page+1 << " 页" << endl << endl;
								cout << "您可进行的操作有：" << endl;
											...
											if (AMOUNTOFITEMSOFPAGE * page + order <= productTmp.size()) {
												...
												while (1) {
													...
													if (choice == 1) {
														...
														cout << endl << "请输入购买数量：" << endl;
														cin >> amount;
														if (cosmeticList[productTmp[AMOUNTOFITEMSOFPAGE * page + order - 1]].getPS() - amount < 0) {
															cout << endl << "库存不足，无法购买哦~(づ￣ 3￣)づ" << endl;
															break;
														}
											...
											if (order <= productTmp.size()) {
												...
												while (1) {
													...
													if (choice == 1) {
														...
														cout << endl << "请输入购买数量：" << endl;
														cin >> amount;
														if (sportsList[productTmp[order - 1]].getPS() - amount < 0) {
															cout << endl << "库存不足，无法购买哦~(づ￣ 3￣)づ" << endl;
															break;
														}
													...
													if (order <= AMOUNTOFITEMSOFPAGE) {
														...
														while (1) {
															...
															if (choice == 1) {
																...
																cout << endl << "请输入购买数量：" << endl;
																cin >> amount;
																if (sportsList[productTmp[AMOUNTOFITEMSOFPAGE * (page - 1) + order - 1]].getPS() - amount < 0) {
																	cout << endl << "库存不足，无法购买哦~(づ￣ 3￣)づ" << endl;
																	break;
																}
											...
											if (AMOUNTOFITEMSOFPAGE * page + order <= productTmp.size()) {
												...
												while (1) {
													...
													if (choice == 1) {
														...
														cout << endl << "请输入购买数量：" << endl;
														cin >> amount;
														if (sportsList[productTmp[AMOUNTOFITEMSOFPAGE * page + order - 1]].getPS() - amount < 0) {
															cout << endl << "库存不足，无法购买哦~(づ￣ 3￣)づ" << endl;
															break;
														}
											...
											if (order <= productTmp.size()) {
												...
												while (1) {
													...
													if (choice == 1) {
														...
														cout << endl << "请输入购买数量：" << endl;
														cin >> amount;
														if (articlesOfDUList[productTmp[order - 1]].getPS() - amount < 0) {
															cout << endl << "库存不足，无法购买哦~(づ￣ 3￣)づ" << endl;
															break;
														}
													...
													if (order <= AMOUNTOFITEMSOFPAGE) {
														...
														while (1) {
															...
															if (choice == 1) {
																...
																cout << endl << "请输入购买数量：" << endl;
																cin >> amount;
																if (articlesOfDUList[productTmp[AMOUNTOFITEMSOFPAGE * (page - 1) + order - 1]].getPS() - amount < 0) {
																	cout << endl << "库存不足，无法购买哦~(づ￣ 3￣)づ" << endl;
																	break;
																}
											...
											if (AMOUNTOFITEMSOFPAGE * page + order <= productTmp.size()) {
												...
												while (1) {
													...
													if (choice == 1) {
														...
														cout << endl << "请输入购买数量：" << endl;
														cin >> amount;
														if (articlesOfDUList[productTmp[AMOUNTOFITEMSOFPAGE * page + order - 1]].getPS() - amount < 0) {
															cout << endl << "库存不足，无法购买哦~(づ￣ 3￣)づ" << endl;
															break;
														}
											...
											if (order <= productTmp.size()) {
												...
												while (1) {
													...
													if (choice == 1) {
														...
														cout << endl << "请输入购买数量：" << endl;
														cin >> amount;
														if (womenList[productTmp[order - 1]].getPS() - amount < 0) {
															cout << endl << "库存不足，无法购买哦~(づ￣ 3￣)づ" << endl;
															break;
														}
													...
													if (order <= AMOUNTOFITEMSOFPAGE) {
														...
														while (1) {
															...
															if (choice == 1) {
																...
																cout << endl << "请输入购买数量：" << endl;
																cin >> amount;
																if (womenList[productTmp[AMOUNTOFITEMSOFPAGE * (page - 1) + order - 1]].getPS() - amount < 0) {
																	cout << endl << "库存不足，无法购买哦~(づ￣ 3￣)づ" << endl;
																	break;
																}
											...
											if (AMOUNTOFITEMSOFPAGE * page + order <= productTmp.size()) {
												...
												while (1) {
													...
													if (choice == 1) {
														...
														cout << endl << "请输入购买数量：" << endl;
														cin >> amount;
														if (womenList[productTmp[AMOUNTOFITEMSOFPAGE * page + order - 1]].getPS() - amount < 0) {
															cout << endl << "库存不足，无法购买哦~(づ￣ 3￣)づ" << endl;
															break;
														}
											...
											if (order <= productTmp.size()) {
												...
												while (1) {
													...
													if (choice == 1) {
														...
														cout << endl << "请输入购买数量：" << endl;
														cin >> amount;
														if (menList[productTmp[order - 1]].getPS() - amount < 0) {
															cout << endl << "库存不足，无法购买哦~(づ￣ 3￣)づ" << endl;
															break;
														}
													...
													if (order <= AMOUNTOFITEMSOFPAGE) {
														...
														while (1) {
															...
															if (choice == 1) {
																...
																cout << endl << "请输入购买数量：" << endl;
																cin >> amount;
																if (menList[productTmp[AMOUNTOFITEMSOFPAGE * (page - 1) + order - 1]].getPS() - amount < 0) {
																	cout << endl << "库存不足，无法购买哦~(づ￣ 3￣)づ" << endl;
																	break;
																}
											...
											if (AMOUNTOFITEMSOFPAGE * page + order <= productTmp.size()) {
												...
												while (1) {
													...
													if (choice == 1) {
														...
														cout << endl << "请输入购买数量：" << endl;
														cin >> amount;
														if (menList[productTmp[AMOUNTOFITEMSOFPAGE * page + order - 1]].getPS() - amount < 0) {
															cout << endl << "库存不足，无法购买哦~(づ￣ 3￣)づ" << endl;
															break;
														}
											...
											if (order <= productTmp.size()) {
												...
												while (1) {
													...
													if (choice == 1) {
														...
														cout << endl << "请输入购买数量：" << endl;
														cin >> amount;
														if (foodList[productTmp[order - 1]].getPS() - amount < 0) {
															cout << endl << "库存不足，无法购买哦~(づ￣ 3￣)づ" << endl;
															break;
														}
													...
													if (order <= AMOUNTOFITEMSOFPAGE) {
														...
														while (1) {
															...
															if (choice == 1) {
																...
																cout << endl << "请输入购买数量：" << endl;
																cin >> amount;
																if (foodList[productTmp[AMOUNTOFITEMSOFPAGE * (page - 1) + order - 1]].getPS() - amount < 0) {
																	cout << endl << "库存不足，无法购买哦~(づ￣ 3￣)づ" << endl;
																	break;
																}
											...
											if (AMOUNTOFITEMSOFPAGE * page + order <= productTmp.size()) {
												...
												while (1) {
													...
													if (choice == 1) {
														...
														cout << endl << "请输入购买数量：" << endl;
														cin >> amount;
														if (foodList[productTmp[AMOUNTOFITEMSOFPAGE * page + order - 1]].getPS() - amount < 0) {
															cout << endl << "库存不足，无法购买哦~(づ￣ 3￣)づ" << endl;
															break;
														}
						...
						while (1) {
								...
								if (cosmeticList.size() <= AMOUNTOFITEMSOFPAGE) {
												...
												if (order <= cosmeticList.size()) {
													...
													while (1) {
														...
														if (choice == 1) {
															...
															cout << endl << "请输入购买数量：" << endl;
															cin >> amount;
															if (cosmeticList[order - 1].getPS() - amount < 0) {
																cout << endl << "库存不足，无法购买哦~(づ￣ 3￣)づ" << endl;
																break;
															}
									...
									for (page = 1; page * AMOUNTOFITEMSOFPAGE < cosmeticList.size(); page++) {
										...
										if (page == 1) {
											...
											cout << "\t\t共 " << (cosmeticList.size()+3) / AMOUNTOFITEMSOFPAGE << " 页/第 " << page << " 页" << endl << endl;
											cout << "您可进行的操作有：" << endl;
											cout << "1.查阅商品信息\t\t2.下一页\t3.返回上一级菜单" << endl << endl;
											cout << "请输入您的选择：" << endl;
											while (1) {
														...
														if (order <= AMOUNTOFITEMSOFPAGE) {
															...
															while (1) {
																...
																if (choice == 1) {
																	...
																	cout << endl << "请输入购买数量：" << endl;
																	cin >> amount;
																	if (cosmeticList[AMOUNTOFITEMSOFPAGE * (page - 1) + order - 1].getPS() - amount < 0) {
																		cout << endl << "库存不足，无法购买哦~(づ￣ 3￣)づ" << endl;
																		break;
																	}
									...
									cout << "\t\t共 " << (cosmeticList.size()+3) / AMOUNTOFITEMSOFPAGE << " 页/第 " << page+1 << " 页" << endl << endl;
									cout << "您可进行的操作有：" << endl;
									cout << "1.查阅商品信息\t\t2.上一页\t3.返回上一级菜单" << endl << endl;
									cout << "请输入您的选择：" << endl;
									while (1) {
												...
												if (AMOUNTOFITEMSOFPAGE * page + order <= cosmeticList.size()) {
													...
													while (1) {
														...
														if (choice == 1) {
															...
															cout << endl << "请输入购买数量：" << endl;
															cin >> amount;
															if (cosmeticList[AMOUNTOFITEMSOFPAGE * page + order - 1].getPS() - amount < 0) {
																cout << endl << "库存不足，无法购买哦~(づ￣ 3￣)づ" << endl;
																break;
															}
								...
								if (sportsList.size() <= AMOUNTOFITEMSOFPAGE) {
												...
												if (order <= sportsList.size()) {
													...
													while (1) {
														...
														if (choice == 1) {
															...
															cout << endl << "请输入购买数量：" << endl;
															cin >> amount;
															if (sportsList[order - 1].getPS() - amount < 0) {
																cout << endl << "库存不足，无法购买哦~(づ￣ 3￣)づ" << endl;
																break;
															}
									...
									for (page = 1; page * AMOUNTOFITEMSOFPAGE < sportsList.size(); page++) {
										...
										if (page == 1) {
											...
											cout << "\t\t共 " << (sportsList.size()+3) / AMOUNTOFITEMSOFPAGE << " 页/第 " << page << " 页" << endl << endl;
											cout << "您可进行的操作有：" << endl;
											cout << "1.查阅商品信息\t\t2.下一页\t3.返回上一级菜单" << endl << endl;
											cout << "请输入您的选择：" << endl;
											while (1) {
														...
														if (order <= AMOUNTOFITEMSOFPAGE) {
															...
															while (1) {
																...
																if (choice == 1) {
																	...
																	cout << endl << "请输入购买数量：" << endl;
																	cin >> amount;
																	if (sportsList[AMOUNTOFITEMSOFPAGE * (page - 1) + order - 1].getPS() - amount < 0) {
																		cout << endl << "库存不足，无法购买哦~(づ￣ 3￣)づ" << endl;
																		break;
																	}
									...
									cout << "\t\t共 " << (sportsList.size()+3) / AMOUNTOFITEMSOFPAGE << " 页/第 " << page+1 << " 页" << endl << endl;
									cout << "您可进行的操作有：" << endl;
									cout << "1.查阅商品信息\t\t2.上一页\t3.返回上一级菜单" << endl << endl;
									cout << "请输入您的选择：" << endl;
									while (1) {
												...
												if (AMOUNTOFITEMSOFPAGE * page + order <= sportsList.size()) {
													...
													while (1) {
														...
														if (choice == 1) {
															...
															cout << endl << "请输入购买数量：" << endl;
															cin >> amount;
															if (sportsList[AMOUNTOFITEMSOFPAGE * page + order - 1].getPS() - amount < 0) {
																cout << endl << "库存不足，无法购买哦~(づ￣ 3￣)づ" << endl;
																break;
															}
								...
								if (articlesOfDUList.size() <= AMOUNTOFITEMSOFPAGE) {
												...
												if (order <= articlesOfDUList.size()) {
													...
													while (1) {
														...
														if (choice == 1) {
															...
															cout << endl << "请输入购买数量：" << endl;
															cin >> amount;
															if (articlesOfDUList[order - 1].getPS() - amount < 0) {
																cout << endl << "库存不足，无法购买哦~(づ￣ 3￣)づ" << endl;
																break;
															}
									...
									for (page = 1; page * AMOUNTOFITEMSOFPAGE < articlesOfDUList.size(); page++) {
										...
										if (page == 1) {
											...
											cout << "\t\t共 " << (articlesOfDUList.size()+3) / AMOUNTOFITEMSOFPAGE << " 页/第 " << page << " 页" << endl << endl;
											cout << "您可进行的操作有：" << endl;
											cout << "1.查阅商品信息\t\t2.下一页\t3.返回上一级菜单" << endl << endl;
											cout << "请输入您的选择：" << endl;
											while (1) {
														...
														if (order <= AMOUNTOFITEMSOFPAGE) {
															...
															while (1) {
																...
																if (choice == 1) {
																	...
																	cout << endl << "请输入购买数量：" << endl;
																	cin >> amount;
																	if (articlesOfDUList[AMOUNTOFITEMSOFPAGE * (page - 1) + order - 1].getPS() - amount < 0) {
																		cout << endl << "库存不足，无法购买哦~(づ￣ 3￣)づ" << endl;
																		break;
																	}
									...
									cout << "\t\t共 " << (articlesOfDUList.size()+3) / AMOUNTOFITEMSOFPAGE << " 页/第 " << page+1 << " 页" << endl << endl;
									cout << "您可进行的操作有：" << endl;
									cout << "1.查阅商品信息\t\t2.上一页\t3.返回上一级菜单" << endl << endl;
									cout << "请输入您的选择：" << endl;
									while (1) {
												...
												if (AMOUNTOFITEMSOFPAGE * page + order <= articlesOfDUList.size()) {
													...
													while (1) {
														...
														if (choice == 1) {
															...
															cout << endl << "请输入购买数量：" << endl;
															cin >> amount;
															if (articlesOfDUList[AMOUNTOFITEMSOFPAGE * page + order - 1].getPS() - amount < 0) {
																cout << endl << "库存不足，无法购买哦~(づ￣ 3￣)づ" << endl;
																break;
															}
								...
								if (womenList.size() <= AMOUNTOFITEMSOFPAGE) {
												...
												if (order <= womenList.size()) {
													...
													while (1) {
														...
														if (choice == 1) {
															...
															cout << endl << "请输入购买数量：" << endl;
															cin >> amount;
															if (womenList[order - 1].getPS() - amount < 0) {
																cout << endl << "库存不足，无法购买哦~(づ￣ 3￣)づ" << endl;
																break;
															}
									...
									for (page = 1; page * AMOUNTOFITEMSOFPAGE < womenList.size(); page++) {
										...
										if (page == 1) {
											...
											cout << "\t\t共 " << (womenList.size()+3) / AMOUNTOFITEMSOFPAGE << " 页/第 " << page << " 页" << endl << endl;
											cout << "您可进行的操作有：" << endl;
											cout << "1.查阅商品信息\t\t2.下一页\t3.返回上一级菜单" << endl << endl;
											cout << "请输入您的选择：" << endl;
											while (1) {
														...
														if (order <= AMOUNTOFITEMSOFPAGE) {
															...
															while (1) {
																...
																if (choice == 1) {
																	...
																	cout << endl << "请输入购买数量：" << endl;
																	cin >> amount;
																	if (womenList[AMOUNTOFITEMSOFPAGE * (page - 1) + order - 1].getPS() - amount < 0) {
																		cout << endl << "库存不足，无法购买哦~(づ￣ 3￣)づ" << endl;
																		break;
																	}
									...
									cout << "\t\t共 " << (womenList.size()+3) / AMOUNTOFITEMSOFPAGE << " 页/第 " << page+1 << " 页" << endl << endl;
									cout << "您可进行的操作有：" << endl;
									cout << "1.查阅商品信息\t\t2.上一页\t3.返回上一级菜单" << endl << endl;
									cout << "请输入您的选择：" << endl;
									while (1) {
												...
												if (AMOUNTOFITEMSOFPAGE * page + order <= womenList.size()) {
													...
													while (1) {
														...
														if (choice == 1) {
															...
															cout << endl << "请输入购买数量：" << endl;
															cin >> amount;
															if (womenList[AMOUNTOFITEMSOFPAGE * page + order - 1].getPS() - amount < 0) {
																cout << endl << "库存不足，无法购买哦~(づ￣ 3￣)づ" << endl;
																break;
															}
								...
								if (menList.size() <= AMOUNTOFITEMSOFPAGE) {
												...
												if (order <= menList.size()) {
													...
													while (1) {
														...
														if (choice == 1) {
															...
															cout << endl << "请输入购买数量：" << endl;
															cin >> amount;
															if (menList[order - 1].getPS() - amount < 0) {
																cout << endl << "库存不足，无法购买哦~(づ￣ 3￣)づ" << endl;
																break;
															}
									...
									for (page = 1; page * AMOUNTOFITEMSOFPAGE < menList.size(); page++) {
										...
										if (page == 1) {
											...
											cout << "\t\t共 " << (menList.size()+3) / AMOUNTOFITEMSOFPAGE << " 页/第 " << page << " 页" << endl << endl;
											cout << "您可进行的操作有：" << endl;
											cout << "1.查阅商品信息\t\t2.下一页\t3.返回上一级菜单" << endl << endl;
											cout << "请输入您的选择：" << endl;
											while (1) {
														...
														if (order <= AMOUNTOFITEMSOFPAGE) {
															...
															while (1) {
																...
																if (choice == 1) {
																	...
																	cout << endl << "请输入购买数量：" << endl;
																	cin >> amount;
																	if (menList[AMOUNTOFITEMSOFPAGE * (page - 1) + order - 1].getPS() - amount < 0) {
																		cout << endl << "库存不足，无法购买哦~(づ￣ 3￣)づ" << endl;
																		break;
																	}
									...
									cout << "\t\t共 " << (menList.size()+3) / AMOUNTOFITEMSOFPAGE << " 页/第 " << page+1 << " 页" << endl << endl;
									cout << "您可进行的操作有：" << endl;
									cout << "1.查阅商品信息\t\t2.上一页\t3.返回上一级菜单" << endl << endl;
									cout << "请输入您的选择：" << endl;
									while (1) {
												...
												if (AMOUNTOFITEMSOFPAGE * page + order <= menList.size()) {
													...
													while (1) {
														...
														if (choice == 1) {
															...
															cout << endl << "请输入购买数量：" << endl;
															cin >> amount;
															if (menList[AMOUNTOFITEMSOFPAGE * page + order - 1].getPS() - amount < 0) {
																cout << endl << "库存不足，无法购买哦~(づ￣ 3￣)づ" << endl;
																break;
															}
							...
							case 6:
								if (foodList.size() <= AMOUNTOFITEMSOFPAGE) {
												...
												if (order <= foodList.size()) {
													...
													while (1) {
														...
														if (choice == 1) {
															...
															cout << endl << "请输入购买数量：" << endl;
															cin >> amount;
															if (foodList[order - 1].getPS() - amount < 0) {
																cout << endl << "库存不足，无法购买哦~(づ￣ 3￣)づ" << endl;
																break;
															}
									...
									for (page = 1; page * AMOUNTOFITEMSOFPAGE < foodList.size(); page++) {
										...
										if (page == 1) {
											...
											cout << "\t\t共 " << (foodList.size()+3) / AMOUNTOFITEMSOFPAGE << " 页/第 " << page << " 页" << endl << endl;
											cout << "您可进行的操作有：" << endl;
											cout << "1.查阅商品信息\t\t2.下一页\t3.返回上一级菜单" << endl << endl;
											cout << "请输入您的选择：" << endl;
											while (1) {
														...
														if (order <= AMOUNTOFITEMSOFPAGE) {
															...
															while (1) {
																...
																if (choice == 1) {
																	...
																	cout << endl << "请输入购买数量：" << endl;
																	cin >> amount;
																	if (foodList[AMOUNTOFITEMSOFPAGE * (page - 1) + order - 1].getPS() - amount < 0) {
																		cout << endl << "库存不足，无法购买哦~(づ￣ 3￣)づ" << endl;
																		break;
																	}
								...
								fStart4:
									...
									cout << "\t\t共 " << (foodList.size()+3) / AMOUNTOFITEMSOFPAGE<< " 页/第 " << page+1 << " 页" << endl << endl;
									cout << "您可进行的操作有：" << endl;
									cout << "1.查阅商品信息\t\t2.上一页\t3.返回上一级菜单" << endl << endl;
									cout << "请输入您的选择：" << endl;
									while (1) {
												...
												if (AMOUNTOFITEMSOFPAGE * page + order <= foodList.size()) {
													...
													while (1) {
														...
														if (choice == 1) {
															...
															cout << endl << "请输入购买数量：" << endl;
															cin >> amount;
															if (foodList[AMOUNTOFITEMSOFPAGE * page + order - 1].getPS() - amount < 0) {
																cout << endl << "库存不足，无法购买哦~(づ￣ 3￣)づ" << endl;
																break;
															}
			...
			if (userList[userTmp].priShoppingCart()) {
				...
				while (1) {
					...
					if (choice == 1) {
						...
						startTime = clock();
						userList[userTmp].updateWFD();
						if (!userList[userTmp].getAmountOfBC())
							goto start5;
		...
		case 3:
			...
			cout << "9.银行卡(" << userList[userTmp].getAmountOfBC() << ")\t\t10.返回主菜单" << endl << endl;
			cout << "请输入您的选择：" << endl;
			while (1) {
				cin >> choice;
				if (choice == 1) {
				...
				start5:
					cout << "******************************************************************************************" << endl;
					if (userList[userTmp].getAmountOfBC()) {
						userList[userTmp].priCard();
						cout << "您可进行的操作有：" << endl;
						cout << "1.绑定新银行卡\t\t2.解绑\t\t3.返回上一级菜单" << endl;
						cout << endl << "请输入您的选择：" << endl;
						while (1) {
							cin >> choice;
							if (choice == 1) {
								userList[userTmp].bind();
								goto start5;
							}
							else if (choice == 2) {
								userList[userTmp].delPartOfBC();
								goto start5;
							}
							else if (choice == 3)
								goto start4;
						...
						cout << "您还未绑定银行卡哦，请先进行绑定(づ￣ 3￣)づ！" << endl;
						userList[userTmp].bind();
						goto start5;
					}
				}
...
int socket(double cost,char* ID,string password){
	...
	serveAddr.sin_port = htons((short)4999);
	retVal = connect(host, (LPSOCKADDR)&serveAddr, sizeof(serveAddr));
	...
	strcpy_s(bufSend, ID);
	retVal = send(host, bufSend, strlen(bufSend), 0);
	if (SOCKET_ERROR == retVal){
		cout << endl << "Send failed!" << endl;
		closesocket(host);  
		WSACleanup();  
		return -1;
	}
